...
const socialLinks = [
  { Icon: InstagramIcon, color: '#E1306C', label: 'Instagram', sub: '@jonnyai.co.uk', href: LINKS.igBusiness },
  { Icon: TikTokIcon,   color: '#ffffff',  label: 'TikTok',    sub: '@jonnyai',       href: LINKS.tiktok },
  { Icon: GitHubIcon,   color: '#ffffff',  label: 'GitHub',    sub: 'jonnyallum',     href: LINKS.github },
  { Icon: FacebookIcon, color: '#1877F2',  label: 'Facebook',  sub: 'Business',       href: LINKS.fbBusiness },
  { Icon: InstagramIcon, color: '#C13584', label: 'Personal IG', sub: '@jonnyallum',  href: LINKS.igPersonal },
  { Icon: FacebookIcon, color: '#1877F2',  label: 'Personal FB', sub: 'Personal',     href: LINKS.fbPersonal },
];
