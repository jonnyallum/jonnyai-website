...
export const marketplaceListings: MarketplaceListing[] = [
  ...
  },
  {
    ...
    includes: [
      "Domain: molingexpert.co.uk (live on Hostinger DNS)",
      "Matching email inbox setup",
      "Brand system + service-page structure",
      "Final GitHub repo + Hostinger deploy script",
    ],
    builtFeatures: [
      "Domain registered + parked on Hostinger",
      "Brand direction defined (no-dig / earthworks aesthetic)",
      "Service taxonomy mapped (water main, drainage, ducting, cable installation)",
      "Page architecture drafted",
    ],
    remaining: [
      "Build out home, services, process, gallery, contact pages",
      "Photography + before/after case-study content",
      "Local SEO schema + Google Business Profile",
      "Quote-request form (Resend or Formspree)",
      "Deploy + DNS cutover",
    ],
    buyerProfile: "Existing moling or no-dig contractor wanting a turnkey lead-gen site under their brand. Or an investor backing the build to launch as an independent service business.",
  },
  {
    slug: "marineflex",
    title: "Marineflex",
