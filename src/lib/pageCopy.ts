...
const copy: Record<Mode, PageCopy> = {
  nerds: {
    ...
    agentsSub: '67+ specialist agents. Hired, trained, and deployed by Jonny. On your project in 48 hours.',
  ...
  public: {
    ...
    problemNew: [
      ...
      '67 specialist professionals on your project',
  ...
  idiots: {
    ...
    agentsHeading: '67 Robot Friends.\nThey All Have Jobs.',
