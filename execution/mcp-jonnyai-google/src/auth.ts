...
if (!process.env.JONNYAI_GCP_OAUTH_CLIENT_ID) {
  dotenv.config({ path: path.resolve(__dirname, "../../../.env") });
}

const CLIENT_ID = process.env.JONNYAI_GCP_OAUTH_CLIENT_ID || process.env.GOOGLE_OAUTH_CLIENT_ID!;
const CLIENT_SECRET = process.env.JONNYAI_GCP_OAUTH_CLIENT_SECRET || process.env.GOOGLE_OAUTH_CLIENT_SECRET!;
...
const authUrl = oauth2Client.generateAuthUrl({
  ...
  scope: SCOPES,
  prompt: "consent",
  login_hint: "info@jonnyai.co.uk",
});

console.log("\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
console.log(" JonnyAI Google Cloud OAuth2 Auth Flow");
console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
  ...
  try {
    ...
    res.end(`
      <html><body style="font-family:sans-serif;text-align:center;padding:40px;background:#0a0a0a;color:#fff">
        ...
        <p style="color:#94a3b8">Cloud Platform · Compute · Drive · Gmail · Calendar · Docs · Sheets · Tasks · Contacts</p>
        <p style="margin-top:30px;color:#64748b">You can close this tab. GCP VM setup can proceed.</p>
      </body></html>
    `);
